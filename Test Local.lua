--[[
    ════════════════════════════════════════════════════════════
    FILE TEST GABUNGAN — library + contoh pemakaian jadi satu.
    Tinggal paste semua ini ke executor lalu Execute (TANPA readfile).
    Kalau udah cocok, pisahkan lagi: bagian library -> NewLibrary.lua
    ════════════════════════════════════════════════════════════
--]]
...
local LOGO_PLACEHOLDER = "rbxassetid://0"
local CONFIG_FOLDER    = "VS_Config"
...
function Library:Setup(config)
    ...
    for _, gui in ipairs(self._location:GetChildren()) do
        if gui.Name == "VS_Library" or gui.Name == "VS_Message" then
